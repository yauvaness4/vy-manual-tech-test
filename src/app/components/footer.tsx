export default function Footer() {
    return (
        <footer className="bg-[#E8EFE9] bx-container">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="https://manual.com/" className="flex items-center">
                            <svg width="40px" height="38px" viewBox="0 0 40 38" className="mb-3">
                                <g id="UI" stroke="none" fill="none" fill-rule="evenodd">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-4">
                        <div>
                            <h2 className="mb-6 text-[10px] font-semibold text-[#0B3B3C] uppercase">Product</h2>
                            <ul className="text-[#0B3B3C] text-base font-light">
                                <li className="mb-4">
                        ...
                        <div>
                            <h2 className="mb-6 text-[10px] font-semibold text-[#0B3B3C] uppercase">Company</h2>
                            <ul className="text-[#0B3B3C] text-base font-light">
                                <li className="mb-4">
                                    <a href="https://github.com/themesberg/manual" className="hover:underline ">Press</a>
                                </li>
                                <li className="mb-4">
                        ...
                        <div>
                            <h2 className="mb-6 text-[10px] font-semibold text-[#0B3B3C] uppercase">Info</h2>
                            <ul className="text-[#0B3B3C] text-base font-light">
                                <li className="mb-4">
                        ...
                        <div>
                            <h2 className="mb-6 text-[10px] font-semibold text-[#0B3B3C] uppercase">Follow us</h2>
                            <div className="flex mt-4 sm:mt-0">

                                <a href="#" className="text-[#7E0707] hover:text-gray-900 dark:hover:text-white">
                                    <svg className="w-4 h-4" strokeWidth="1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                                        <path fillRule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clipRule="evenodd" />
                                    </svg>
                                    <span className="sr-only">Facebook page</span>
                                </a>
                                <a href="#" className="text-[#7E0707] hover:text-gray-900 dark:hover:text-white ms-5">
                                    <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50" fill="currentColor" >
                                        <path fillRule="evenodd" d="M 25.996094 48 C 13.3125 48 2.992188 37.683594 2.992188 25 C 2.992188 12.316406 13.3125 2 25.996094 2 C 31.742188 2 37.242188 4.128906 41.488281 7.996094 L 42.261719 8.703125 L 34.675781 16.289063 L 33.972656 15.6875 C 31.746094 13.78125 28.914063 12.730469 25.996094 12.730469 C 19.230469 12.730469 13.722656 18.234375 13.722656 25 C 13.722656 31.765625 19.230469 37.269531 25.996094 37.269531 C 30.875 37.269531 34.730469 34.777344 36.546875 30.53125 L 24.996094 30.53125 L 24.996094 20.175781 L 47.546875 20.207031 L 47.714844 21 C 48.890625 26.582031 47.949219 34.792969 43.183594 40.667969 C 39.238281 45.53125 33.457031 48 25.996094 48 Z"></path>
                                    </svg>
                ...
                <hr className="my-6 border-gray-200 sm:mx-auto border-[#BDCDC5] lg:my-8" />
                <div className="text-center">
                    <span className="text-sm text-[#0B3B3C] sm:text-center dark:text-gray-400">© 2024 <a href="https://manual.com/" className="hover:underline">Manual</a>. All Rights Reserved.
                    </span>
